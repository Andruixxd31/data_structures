...
public class Recursion {
    ...
    public static void main(String[] args) {
        ...
        // recursionTool.calculateSquaresToPrint(6); //See what a triangular number
        // looks like

        // System.out.println("\nTriangular Number: " +
        // recursionTool.getTriangularNum(6) + "\n");
    ...
    // Calculate triangular number using an iterative method
    public int getTriangularNum(int number) {
        ...
        // If number equals 6, you find TN by adding 6+5+4+3+2+1 = 21
    ...
    public int getTriangularNumR(int number) {
        ...
        if (number == 1) {
            ...
            return 1; // This is the base case method
        } else {
