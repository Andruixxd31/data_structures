public class EmployeeLinkedList {
    ...
    public void addToFront(Employee employee) {
        ...
        node.setNext(head); // points to the node infront of it. the head is the element that came before
                            // this one
        head = node; // the head is updated to this current employee, if anothe element is added this
                     // head will be used to point into this employee
    ...
    public EmployeeNode removeFromFront() {
        ...
        head = head.getNext(); // head is now the element infront of it, since this one will be deleted
