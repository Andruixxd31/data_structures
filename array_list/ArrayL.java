...
public class ArrayL {
    ...
    public static void main(final String[] args){
        ...
        //A backing array is the one that coaintains the data
        ...
        employeeList.add(3,new Employee("Doe", "Papajohns", 000)); //will add it at pos 3 and the values equal or above three will bi shifted up by one
        employeeList.forEach(employee -> System.out.println(employee)); //Method already built in the interface
        System.out.println();
