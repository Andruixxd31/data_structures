 ...
 *
 * @author William Fiset, william.alexandre.fiset@gmail.com Code obatained in
 *         free codecamp
 */
...
public class BinarySearchTree<T extends Comparable<T>> {
    ...
    private class Node { // class of Node
        T data; // comparale type T
        Node left, right; // contains a left and right node

        public Node(Node left, Node right, T elem) { // constructor of the class
            this.data = elem;
            this.left = left;
            this.right = right;
        }
    ...
    public int size() {
        return nodeCount; // increments and decrements as we add and remove nodes
    }
    ...
    private int height(Node node) {
        if (node == null)
            return 0;
        // Checks the heigh of the left and right subtree, in each recursive call we add
        // 1, at the end max will return the subtree with the most depth
