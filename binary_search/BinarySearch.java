...
public class BinarySearch {
    ...
    public static int binarySearch(int[] a, int key) {
        int lo = 0, hi = a.length; // Lo and hi cover the first and last element
        while (lo <= hi) {
            ...
            if (key < a[mid]) {
                ...
                // The hi value will be changed so that everything bigger or equal to mid is
                // ignored
        ...
        // In this case lo and hi are in the same index or they switched sides to one
        // another
